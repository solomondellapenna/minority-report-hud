bs_package_flags = -bs-package-name sdl2
src_root_dir = /Users/solomondellapenna/minority-report-hud/node_modules/sdl2
...
open_flag = 
bsb_helper_verbose = 
bsc_lib_includes = -I /Users/solomondellapenna/minority-report-hud/node_modules/bs-platform/vendor/ocaml/lib/ocaml -I fake_src
...
build fake_src/sdl_index.mlast : build_ast_and_module_sets_gen_simple $src_root_dir/fake_src/sdl_index.ml
rule build_deps_bytecode
  command = ${bsb_helper} ${namespace} -g ${bsb_dir_group} -MD-bytecode ${in}
  description = [34mBuilding[39m [2m${out}[22m
build fake_src/sdl_index.mlast.d : build_deps_bytecode fake_src/sdl_index.mlast
rule build_cmo_cmi_bytecode
  ...
  depfile = ${in}.d
  description = [34mBuilding[39m [2m${out}[22m
build fake_src/sdl_index.cmo |  fake_src/sdl_index.cmi : build_cmo_cmi_bytecode fake_src/sdl_index.mlast
  bs_package_flags = $bs_package_flags  -bs-package-output commonjs:lib/js/fake_src
rule build_cma_library
  ...
  description = [34mBuilding[39m [2m${out}[22m
build lib.cma : build_cma_library  fake_src/sdl_index.cmo |  fake_src/sdl_index.cmi
build build.ninja : phony  ||  fake_src/sdl_index.mlast.d
